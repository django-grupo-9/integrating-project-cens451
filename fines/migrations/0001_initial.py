    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barrio', models.CharField(max_length=55, verbose_name='Localidad/Barrio')),
                ('celular_2', models.CharField(blank=True, max_length=10, verbose_name='Celular 2')),
                ('estudios', models.CharField(max_length=255, null=True, verbose_name='Estudios previos')),
                ('otros_estudios', models.CharField(max_length=255, null=True, verbose_name='Otros estudios')),
                ('materias_adeudadas', models.TextField(blank=True, verbose_name='Materias Adeudadas')),
                ('colegio', models.CharField(max_length=255, null=True, verbose_name='Colegio')),
                ('pais', models.CharField(max_length=50, null=True, verbose_name='País del colegio')),
                ('provincia', models.CharField(max_length=50, null=True, verbose_name='Provincia del colegio')),
                ('localidad', models.CharField(max_length=50, null=True, verbose_name='Ciudad del colegio')),
                ...
                ('sede', models.CharField(max_length=55, null=True, verbose_name='Sede de preferencia')),
